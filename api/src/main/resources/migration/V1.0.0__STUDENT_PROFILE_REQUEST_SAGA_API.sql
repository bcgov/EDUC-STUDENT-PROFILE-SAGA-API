...
(
    ...
    STUDENT_PROFILE_REQUEST_ID VARCHAR(50)                         NULL,
    CREATE_USER              VARCHAR(32)                         NOT NULL,
    CREATE_DATE              TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    UPDATE_USER              VARCHAR(32)                         NOT NULL,
    UPDATE_DATE              TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT PEN_REQUEST_SAGA_PK PRIMARY KEY (SAGA_ID)
);
CREATE INDEX STUDENT_PROFILE_SAGA_STUDENT_PROFILE_REQUEST_IDX ON STUDENT_PROFILE_SAGA (STUDENT_PROFILE_REQUEST_ID);
...
(
    ...
    UPDATE_USER         VARCHAR(32)                         NOT NULL,
    UPDATE_DATE         TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT PEN_REQUEST_SAGA_EVENT_STATES_PK PRIMARY KEY (SAGA_EVENT_ID)
);
