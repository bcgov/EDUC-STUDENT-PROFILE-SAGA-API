...
@ActiveProfiles("test")
@SpringBootTest
public class StudentProfileRejectSagaOrchestratorTest {
  ...
  public void setUp() throws Exception {
    ...
    saga = sagaService.createPenRequestSagaRecord(getSagaData(getPayload()), STUDENT_PROFILE_REJECT_SAGA.toString(), "OMISHRA",
  ...
  public void testExecuteNotifyStudent_givenEventAndSagaData_shouldPostEventToProfileEmailApi() throws IOException, InterruptedException, TimeoutException {
    var event = Event.builder()
        ...
        .sagaId(saga.getSagaId())
        .build();
    orchestrator.executeNotifyStudentProfileRequestRejected(event, saga, sagaData);
  ...
  StudentProfileRequestRejectActionSagaData getSagaData(String json) {
    try {
